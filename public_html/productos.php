        ...
        <div id="content_principal">
            ...
            <div id="content_second">
                <div id="content_productos">
                    <div class="producto izq">
                        <div class="producto_etiqueta">
                        ...
                        <?php
                            ...
                            $directorio = opendir('img/stones'); //ruta actual
                       ...
                       ?>                                
                                ...
                                <li><img src="<?php echo "img/stones/".$archivo ?>" /></li>
                    ...
                    <div class="producto der">
                        ...
                        <?php
                            ...
                            $directorio = opendir('img/blinds'); //ruta actual
                            while ($archivo = readdir($directorio)) //obtenemos un archivo y luego otro sucesivamente
                            {
                                if (!is_dir($archivo))//verificamos si es o no un directorio
                                {
                       ...
                       ?>                                
                                ...
                                <li><img src="<?php echo "img/blinds/".$archivo ?>" /></li>

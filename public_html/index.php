...
<!--codigo por http://adan-2994.es.tl/Efecto-Pop_up.htm -->
...
$(document).ready(function(){
	pop=$("div#pop-up");
		...
		function abrir(){ 
			pop.stop().css( 'display','block' ).animate({
								'left':'33%',
								'opacity':1
								} ,900); 
		}
...
<!-- Fin plugin Facebook -->
                        ...
                        <?php
                            ...
                            $directorio = opendir('popup'); //ruta actual
                            while ($archivo = readdir($directorio)) //obtenemos un archivo y luego otro sucesivamente
                            {
                                
                                if (!is_dir($archivo))//verificamos si es o no un directorio
                                {
                                    if($archivo=='popup.jpg' || $archivo=='popup.png'){
                       ?>
                                    
                                    <div id="pop-up" >
                                        <div style="cursor:pointer;width:28px;height:28px;background-size:28px;background-image:url(img/cerrar2.png);background-repeat:no-repeat;" id="cerrar"></div>
                ...
                <div id="slider_principal">
                    ...
                    <ul>
                        ...
                        <?php
                            ...
                            $directorio = opendir('index'); //ruta actual
                            while ($archivo = readdir($directorio)) //obtenemos un archivo y luego otro sucesivamente
                            {
                                if (!is_dir($archivo))//verificamos si es o no un directorio
                                {
                       ...
                       ?>
                                            <li>
                                                <img src="<?php echo 'index/'.$archivo ?>" alt="Luxury persianas, cortinas y piedra para piso" />
                                            </li>
